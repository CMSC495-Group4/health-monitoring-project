            ...
            if (term.isSelected()) { 
                ...
                if (male.isSelected()) 
                	...
                	if (sedentary.isSelected()) 
                        data5 = "Activity Level: Sedentary" + "\n"; 
                    else if (lightActive.isSelected()) 
                        data5 = "Activity Level: Light Activity" + "\n"; 
                    else if (modActive.isSelected()) 
                        data5 = "Activity Level: Moderate Activity" + "\n"; 
                    else if (veryActive.isSelected()) 
                        data5 = "Activity Level: Very Active" + "\n"; 
                    else if (extraActive.isSelected()) 
                        data5 = "Activity Level: Extra Active" + "\n"; 
                    else
